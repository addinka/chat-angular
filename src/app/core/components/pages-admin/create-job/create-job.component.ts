...
export class CreateJobComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.depItems = Arrays.DEPARTMENT;
    this.statItems = Arrays.STSCONTRACT;
    ...
    this.jobService.getJobDetail(this.jobID).toPromise()
      .then(
        data => {
          ...
          this.createJobForm.controls['contractStatus'].setValue(data['contractStatus']);
          this.createJobForm.controls['department'].setValue(data['department']);
