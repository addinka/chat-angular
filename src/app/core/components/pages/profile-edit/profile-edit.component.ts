...
export class ProfileEditComponent implements OnInit {
  ...
  public informationSources: string[] = Arrays.INFORMATION;
      ...
      .then(
        data => {
         ...
         // console.log(data);
          ...
          this.editForm.controls['informationSource'].setValue(data['informationSource']);
  ...
  onSubmit() {
    ...
    const applicationData = {
      ...
      informationSource: this.editForm.value.informationSource,
    };
