...
export class Arrays {
  ...
  public static DEPARTMENT = ['IBM Consulting', 'Resource Deployment', 'Managed Account', 'TTS','Solution & Competency', 'JTI Internal' ];
  public static STSCONTRACT = ['PENDING','APPROVE'];
  ...
  public static CANDIDATE_SEARCH_TYPES = ['name', 'number', 'title', 'qualification', 'cvcontent'];
}
